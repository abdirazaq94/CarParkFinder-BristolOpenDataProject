...
- End users can search for local car parks by location, Car Park name, prices or spaces available in a car park
- Results of searches are shown on an interactive map with pinpoint markers to show futher details such as spaces that are available, payment methods and opening hours.
- The interface is fully responsive and it adapts to different screen sizes to ensure usability across different devices.
